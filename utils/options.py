...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--juhe', type=str, default='fisher', help="noniid label number of client ")
    parser.add_argument('--ja', type=int, default=1, help="DP")
    parser.add_argument('--juleiyiju', type=str, default="fisher", help="DP")
    parser.add_argument('--dp_type', type=int, default=2, help="TYPE")
    parser.add_argument('--layers', type=int, default=2, help="n-layer")
    parser.add_argument('--hy', type=float, default=0.0, help="zhengzexiang")
